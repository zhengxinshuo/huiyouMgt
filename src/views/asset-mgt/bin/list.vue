<template>
    <div class="page-container">
        <div class="layout-box">
            ...
            <el-button :disabled="!tableSelection.length" type="primary" size="small">批量还原</el-button>
            <el-button
            ...
            >
                ...
                <el-table-column prop="unitName" label="规格型号"></el-table-column>
                <el-table-column prop="projectStep" label="序列号"></el-table-column>
                <el-table-column prop="projectStep" label="版本号"></el-table-column>
                <el-table-column prop="projectStep" label="删除人"></el-table-column>
                <el-table-column prop="projectState" width="150" sortable label="删除时间"></el-table-column>
