        ...
        <el-tabs v-model="form.step" type="border-card">
            ...
            <el-tab-pane name="1" label="所有资产">
                ...
                >
                    ...
                    <el-table-column prop="projectState" width="150" sortable label="质保结束时间"></el-table-column>
            ...
            <el-tab-pane name="2" label="未验收">
                <el-row :gutter="10" class="tip">
                    ...
                    <el-col :span="23">
                        <p>
                            1.该页面展示的内容是“进行中”的合同及项目下的资产，若需新增请到“合同详情-硬件设备”或“项目概况-设备到货”页进行录入。
                        </p>
                        <p>
                            2.当合同或项目验收成功后，设备信息将更新至“所有硬件”列表页。
                        </p>
                    </el-col>
                </el-row>
                <el-button type="primary" size="small">表格导出</el-button>
