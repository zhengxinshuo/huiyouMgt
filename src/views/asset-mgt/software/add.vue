            ...
            <el-row>
                <el-col :span="20" class="tip">
                    <el-row>
                        ...
                        <el-col :span="23">
                            本页面所录入的资产为通过零散采购或捐赠等方式获取的资产，若需录入合同/项目资产，请到合同/项目-设备到货页录入。
                        </el-col>
                    </el-row>
                </el-col>
            ...
            >
                    ...
                    <el-row class="form-row">
                        <el-col :span="12">
                            <el-form-item :rules="{required:true,message:'请输入资产名称'}" prop="name" label="资产名称">
                                <el-input v-model="form.name" placeholder="请输入资产名称" clearable></el-input>
                                <span class="form-tip">最多30个字</span>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="原院方编号">
                ...
                <form-box>
                    ...
                    <el-row class="form-row">
                        ...
                        <el-col :span="12">
                            <el-form-item label="使用科室" prop="value">
                                <el-select v-model="form.value" filterable>
