<template>
    <div class="page-container">
        <el-tabs v-model="form.step" type="border-card">
            ...
            <el-tab-pane name="1" label="所有项目"></el-tab-pane>
            <el-tab-pane name="2" label="进行中项目"></el-tab-pane>
            <el-tab-pane name="3" label="延期项目"></el-tab-pane>
            <el-table
            ...
            >
                ...
                <el-table-column prop="projectStep" label="项目阶段"></el-table-column>
                <el-table-column prop="projectState" label="项目状态"></el-table-column>
                ...
                <el-table-column prop="action" label="操作" fixed="right" width="280" fix>
                    <template slot-scope="scope">
                        <el-button type="text" size="small" @click="view(scope.row.projectId)">查看</el-button>
