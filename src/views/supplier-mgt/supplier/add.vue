            ...
            >
                <form-box>
                    <el-row class="form-row">
                        <el-col :span="24">
                            <el-form-item :rules="{required:true,message:'请输入'}" prop="value" label="供应商名称">
                    ...
                    <el-row class="form-row">
                        <el-col :span="24">
                            <el-form-item prop="value" label="供应商代号">
                                <el-input placeholder="请输入供应商代号"></el-input>
                        ...
                        <el-col :span="24">
                            <el-form-item label="合作级别">
                                <el-radio-group v-model="form.radio">
                                    <el-radio :label="2">普通级</el-radio>
                                    <el-radio :label="1">重要级</el-radio>
                                    <el-radio :label="1">战略级</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row class="form-row">
                        <el-col :span="24">
                            <el-form-item label="业务范围">
                                <el-button type="primary">添加业务范围</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row class="form-row">
    ...
    methods: {
        init() {
            if (this.$route.query.type === '0') {
                this.$route.meta.title = '新增供应商'
            } else {
                this.$route.meta.title = '修改供应商'
            }
