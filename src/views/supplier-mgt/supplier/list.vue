    ...
    <div class="page-container">
        <div class="layout-box">
            ...
            >
                ...
                <el-form-item label="合作级别" prop="name">
                    <el-select v-model="form.value" clearable>
                        <el-option label="全部" value="1"></el-option>
                        <el-option label="战略级" value="2"></el-option>
                        <el-option label="重要级" value="3"></el-option>
                        <el-option label="普通级" value="4"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
            ...
            >
                ...
                <el-table-column prop="contractId" label="供应商名称"></el-table-column>
                <el-table-column prop="contractName" label="行业"></el-table-column>
                <el-table-column prop="contractClassify" label="业务范围"></el-table-column>
                <el-table-column prop="unitName" label="合作级别">
                    <template slot-scope="scope">
                        <el-tag type="warning" size="small">普通级</el-tag>
                    </template>
                </el-table-column>
                <el-table-column prop="time" label="我方对接人"></el-table-column>
