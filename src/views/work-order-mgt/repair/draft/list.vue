    ...
    <div class="page-container">
        <div class="layout-box">
            ...
            >
                ...
                <el-table-column prop="contractId" label="工单类型"></el-table-column>
                <el-table-column prop="contractName" label="报修科室"></el-table-column>
                <el-table-column prop="contractClassify" label="紧急程度"></el-table-column>
                <el-table-column prop="unitName" label="工程师">
                </el-table-column>
                <el-table-column prop="time" srotable label="报修时间"></el-table-column>
                <el-table-column prop="time" label="录音"></el-table-column>
